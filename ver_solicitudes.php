...
try {
    ...
    if ($solicitudes):
        ?>
        <h2 style="margin-left: 20px;">Solicitudes Realizadas</h2>
        <table>
            <thead>
                <tr>
                    <th>ID Solicitud</th>
    ...
    <?php
        ...
        echo "<p style='margin-left: 20px;'>No se encontró ninguna solicitud para este cliente.</p>";
    endif;

} catch (Exception $e) {
    echo "<p style='margin-left: 20px; color: red;'>Error al obtener las solicitudes: " . $e->getMessage() . "</p>";
} finally {
